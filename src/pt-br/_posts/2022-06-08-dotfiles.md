...
repositório [*dotfiles*](https://github.com/eugeniojimenes/dotfiles){:target="_blank"}.
<!-- excerpt-end -->
...
[meu próprio repositório](https://github.com/eugeniojimenes/dotfiles){:target="_blank"} foi o *Vim*.
...
[aqui](https://github.com/eugeniojimenes/dotfiles){:target="_blank"}.
{: .note-warning }
